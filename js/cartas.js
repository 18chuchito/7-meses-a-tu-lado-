...
const cartas = document.querySelector('.contenedor-cartas');

sobre.addEventListener('click', () => {

  // animación de salida
  sobre.style.opacity = '0';
  sobre.style.transform = 'scale(0.5)';

  setTimeout(() => {
    sobre.style.display = 'none'; // 🔥 elimina el espacio totalmente
  }, 600);

  cartas.classList.add('mostrar');
});
